//
//  AlbumMenuPreview_honeycrisp.swift
//  om-17
//
...
struct AlbumMenuPreview_honeycrisp: View {
    var album: Album
    @State var realURL: String = ""
    var body: some View {
        VStack(alignment: .leading) {
            AlbumArtDisplay(ArtworkID: realURL, Resolution: .tile, Blur: 20, BlurOpacity: 0.3, cornerRadius: 8.0)
...
#Preview {
    Text("Press to Reveal")
        .contextMenu {
            ...
            AlbumMenuPreview_honeycrisp(album: SearchedAlbum(default: true))
        }
