//
//  QPPlaylistLink_honeycrisp.swift
//  om-17
//
...
struct QPPlaylistLink_honeycrisp: View {
    ...
    var body: some View {
        HStack {
            ...
            .background {
                PlaylistBackground(playlist: playlist, blur: 40, light_opacity: 0, dark_opacity: 0, spin: false)
