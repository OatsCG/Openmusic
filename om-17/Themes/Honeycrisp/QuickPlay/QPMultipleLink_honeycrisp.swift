//
//  QPMultipleLink_honeycrisp.swift
//  om-17
//
...
struct QPMultipleLink_honeycrisp: View {
    ...
    var body: some View {
        HStack {
            ...
            .background {
                AlbumBackground(ArtworkID: tracks[0].Album.Artwork, blur: 40, light_opacity: 0, dark_opacity: 0, spin: false)
...
#Preview {
    QPMultipleLink_honeycrisp(tracks: [FetchedTrack(default: true), FetchedTrack(default: true)])
