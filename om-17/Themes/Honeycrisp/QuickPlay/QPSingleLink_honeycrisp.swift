...
struct QPSingleLink_honeycrisp: View {
    ...
    var body: some View {
        HStack {
            ...
            .background {
                AlbumBackground(ArtworkID: track.Album.Artwork, blur: 40, light_opacity: 0, dark_opacity: 0, spin: false)
...
#Preview {
    QPSingleLink_honeycrisp(track: FetchedTrack(default: true))
