//
//  AlbumContentHeadingBig_honeycrisp.swift
//  om-17
//
...
struct AlbumContentHeadingBig_honeycrisp: View {
...
#Preview {
    ...
    return ScrollView {
        AlbumContentHeadingBig_honeycrisp(album: SearchedAlbum(default: true), tracks: [])
            //.frame(height: 200)
            .border(.red)
    }
