...
struct ThemePreview_linen: View {
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            SearchTrackLink_linen(track: track1)
                .disabled(true)
            ...
            QPMultipleLink_linen(tracks: [track3, track4, track5])
                .disabled(true)
            ...
            HStackWrapped(rows: 1) {
                SearchAlbumLink_linen(album: track6.Album)
